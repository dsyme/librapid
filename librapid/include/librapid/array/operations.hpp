...
namespace librapid {
	namespace detail {
		...
		LIBRAPID_UNARY_FUNCTOR(Asinh, ::librapid::asinh); // asinh(a)
		LIBRAPID_UNARY_FUNCTOR(Acosh, ::librapid::acosh); // acosh(a)
		LIBRAPID_UNARY_FUNCTOR(Atanh, ::librapid::atanh); // atanh(a)

		LIBRAPID_UNARY_FUNCTOR(Exp, ::librapid::exp);	  // exp(a)
		LIBRAPID_UNARY_FUNCTOR(Exp2, ::librapid::exp2);	  // exp2(a)
		LIBRAPID_UNARY_FUNCTOR(Exp10, ::librapid::exp10);	  // exp10(a)
